...
namespace PrincePortalWeb.Controllers
{
    public class suppliersController : Controller
    {
        private SupplierDBModel db = new SupplierDBModel();
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "supplierid,suppliername,address1,county,country,telephone,address2,postcode,webstatus,status,LastreviewedBy,Whencompliant,Reviewdate")] supplier supplier)
        {
            if (ModelState.IsValid)
            {
