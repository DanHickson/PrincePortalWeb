...
//     Configuration file:     "PrincePortalWeb\Web.config"
//     Connection String Name: "DefaultConnection"
//     Connection String:      "Data Source=mssql4.gear.host;Database=danhicksonsql;User Id=danhicksonsql;password=**zapped**;;"
// ------------------------------------------------------------------------------------------------
...
namespace PrincePortalWeb
{
    ...
    public class AspNetUser
    {
        ...
        public string WebStatus { get; set; } // webStatus
        public System.DateTime LastLogDateTime { get; set; } // LastLogDateTime
    ...
    public class Supplier
    {
        ...
        public string Postcode { get; set; } // postcode (length: 11)
        public string Webstatus { get; set; } // webstatus (length: 20)
    ...
    public class AspNetUserConfiguration : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<AspNetUser>
    {
        ...
        public AspNetUserConfiguration(string schema)
        {
            ...
            Property(x => x.SupplierName).HasColumnName(@"supplierName").HasColumnType("nvarchar(max)").IsOptional();
            Property(x => x.FirstLogin).HasColumnName(@"firstLogin").HasColumnType("nvarchar(max)").IsOptional();
            Property(x => x.WebStatus).HasColumnName(@"webStatus").HasColumnType("nvarchar(max)").IsOptional();
            Property(x => x.LastLogDateTime).HasColumnName(@"LastLogDateTime").HasColumnType("datetime2").IsRequired();
        }
    }
    ...
    public class SupplierConfiguration : System.Data.Entity.ModelConfiguration.EntityTypeConfiguration<Supplier>
    {
        ...
        public SupplierConfiguration(string schema)
        {
            ...
            Property(x => x.Suppliername).HasColumnName(@"suppliername").HasColumnType("nvarchar").IsRequired().HasMaxLength(50);
            Property(x => x.Address1).HasColumnName(@"address1").HasColumnType("nvarchar").IsOptional().HasMaxLength(50);
            Property(x => x.County).HasColumnName(@"county").HasColumnType("nvarchar").IsOptional().HasMaxLength(50);
            Property(x => x.Country).HasColumnName(@"country").HasColumnType("nvarchar").IsOptional().HasMaxLength(50);
            Property(x => x.Telephone).HasColumnName(@"telephone").HasColumnType("nvarchar").IsOptional().HasMaxLength(50);
            Property(x => x.Address2).HasColumnName(@"address2").HasColumnType("nvarchar").IsOptional().HasMaxLength(50);
            Property(x => x.Postcode).HasColumnName(@"postcode").HasColumnType("nvarchar").IsOptional().HasMaxLength(11);
            Property(x => x.Webstatus).HasColumnName(@"webstatus").HasColumnType("nvarchar").IsOptional().HasMaxLength(20);
